...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for fixture in fixtures:
            if fixture["model"] == "catalog.category":
                pk = fixture["pk"]
                fields = fixture["fields"]
                Category(pk=pk, **fields).save(force_insert=True)
                print(
                    f"Категория: <{fields["name"]}> загружена в базу"
                )

        for fixture in fixtures:
            if fixture["model"] == "catalog.product":
                pk = fixture["pk"]
                fields = fixture["fields"]
                ...
                print(f"Продукт <{fields["name"]}> с загружен в базу")
        print("Все данные успешно занесены в базу")
